...
@Component
public class NotificationClientImpl extends ConsulDiscoveryClientTemplate implements NotificationClient {
	...
	protected String extractPath() {
		...
		try {
			...
			throw new DataValidationException("the URL is malformed, support.notifications.notification.url: " + url);
		}
		return result;
	}
