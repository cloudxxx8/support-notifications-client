...
public interface NotificationClient {
	...
	List<Notification> findBySender(@PathParam("sender") String sender, @PathParam("limit") int limit);

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/{start}/{end}/{limit}")
	List<Notification> findByCreatedDuration(@PathParam("start") long start, @PathParam("end") long end,
			@PathParam("limit") int limit);

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/start/{start}/{limit}")
	List<Notification> findByCreatedAfter(@PathParam("start") long start, @PathParam("limit") int limit);
