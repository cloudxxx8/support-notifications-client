...
@Component
public class TransmissionClientImpl extends ConsulDiscoveryClientTemplate implements TransmissionClient {
	...
	protected String extractPath() {
		...
		try {
			...
			throw new DataValidationException("the URL is malformed, support.notifications.transmission.url: " + url);
		}
		return result;
	}
