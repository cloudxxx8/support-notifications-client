...
import org.edgexfoundry.notifications.client.ConsulDiscoveryClientTemplate;
...
@Component
public class SubscriptionClientImpl extends ConsulDiscoveryClientTemplate implements SubscriptionClient {
	...
	protected String extractPath() {
		...
		try {
			...
			throw new DataValidationException("the URL is malformed, support.notifications.subscription.url: " + url);
		}
		return result;
	}
